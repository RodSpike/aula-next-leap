...
serve(async (req) => {
  ...
  try {
    ...
    // Check active or trialing (legacy) subscriptions
    ...
    logStep("Active subscription found", { subscriptionId: activeSub.id, status: activeSub.status, endDate: subscriptionEnd });
